...
import sam from '../../assets/kyt.jpg'
                        ...
                        <div class="hidden md:block">
                            <div class="flex items-baseline ml-10 space-x-4">
                                <a class="text-textColor  hover:text-blueColor px-3 py-2 rounded-md text-sm font-medium" href="#">
                                    <Link to={"/homebiller"} smooth>Home</Link>
                                </a>
                                <a class="text-textColor  hover:text-blueColor   px-3 py-2 rounded-md text-sm font-medium" href="#">
                                    <Link to={"/billernotification"} smooth>Notification</Link>
                                </a>
                                <a class="text-textColor  hover:text-blueColor px-3 py-2 rounded-md text-sm font-medium" href="#">
                                    <Link to={"/billerappointment"} smooth>Appointment</Link>
                                </a>
                        ...
                        <div class="flex items-center ml-4 md:ml-6">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a  onClick={handleClose}><Link to={"/loginbillerdiv"}>Logout</Link></a>
                                </div>
                            </div>
                        </div>
                    </div>
