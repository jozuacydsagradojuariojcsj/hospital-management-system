...
const {first_name, middleinitial,last_name, age, sex	, address, city	, 
    ...
    date_of_checkup, treatment, patient_referred_to
} =  state;
...
const handleSubmit = (e) => {
    ...
    if(!patient_number || !first_name|| !middleinitial || !last_name || !age || !sex	 || !address	 || !city	 || !phone_number	 || !entry_date	 || !doctor_number	|| !doctor_name_referred_to || !diagnosis	 || !department_name ||
        ...
        toast.error("Fill out all the necessary information!");
            ...
            axios.post("http://localhost:5002/api/post/checkup", {
            patient_number, 
            doctor_number	, 
            date_of_checkup,
            diagnosis,
        ...
        toast.success("Data Saved Successfully to the Check Up Patient Table!");
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div className='shadow-lg'>
                            ...
                            <div className='mt-10'>
                                ...
                                <h1 className='font-bold text-greenColor text-[16px] ms-5 mb-5 me-5 border-b-[2px]'>CHECKUP PATIENT DATA RECORD</h1>

                                <div className='flex justify-between mx-5 my-2 '>
                                <label htmlFor="date_of_checkup">Date of Check-Up</label>
                                <input className='ms-10 text-center border-[1px] border-greenColor w-[155px]' type="date" id='date_of_checkup' name="date_of_checkup" placeholder='Date of Check-Up...' value={date_of_checkup || ""} onChange={handleInputChange}/>
                                </div>
                                ...
                                <div className='flex justify-between mx-5 my-2 '>
                                    <label htmlFor="patient_referred_to">Patient Referred to</label>
                                    <select className='ms-10 text-center border-[1px] border-greenColor w-[155px]' name="patient_referred_to" id="patient_referred_to" value={patient_referred_to || ""} onChange={handleInputChange}>
                                        <option value="Placeholder"> Select Status here...</option>
                                ...
                                <div className='flex justify-end mt-5 mb-5 me-2'>
