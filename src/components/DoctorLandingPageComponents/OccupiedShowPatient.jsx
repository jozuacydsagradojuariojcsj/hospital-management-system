...
const handleInputChange = (e) => {
  ...
  return (
    <div className='m-10 border-[1px] border-greenColor p-7'>
        <div className=''>
            <Link  to={`/occupiedroomdetails/${doctor_number}`}>
                ...
                <div className=''>
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div className='shadow-lg w-[400px]'>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor' type="text" id='middleinitial' name="middleinitial" placeholder='First Name...' value={middleinitial || ""} onChange={handleInputChange}/>
                            </div>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor' type="text" id='doctor_name_referred_to' name="doctor_name_referred_to" placeholder='First Name...' value={doctor_name_referred_to || ""} onChange={handleInputChange}/>
                            </div>
                        ...
                        <div className='shadow-lg'>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor' type="text" id='advance_payment' name="advance_payment" placeholder='Advance Payment...' value={advance_payment || ""} onChange={handleInputChange}/>
                            </div>
