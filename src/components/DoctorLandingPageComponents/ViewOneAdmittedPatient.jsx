  ...
  return (
    <div className='m-10 border-[1px] border-greenColor p-7'>
        <div className=''>
            ...
            <Link to={`/operatepatient/${patient_number}`}>
                <input className='mx-3 px-10 py-1 rounded-full bg-green-500 text-white font-semibold hover:bg-green-400' type="button" value="Schedule an Operation" />     
            </Link>

            <Link to={`/dischargepatient/${patient_number}`}>
