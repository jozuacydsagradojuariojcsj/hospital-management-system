...
const {first_name, middleinitial,last_name, age, sex	, address, city	, 
    phone_number	, entry_date	, doctor_number	, diagnosis	,department_name,
    treatment_given, treatment_advice, payment_made, mode_of_payment, date_of_discharge
} =  state;
...
const handleSubmit = (e) => {
    e.preventDefault();
    if(!patient_number || !first_name|| !middleinitial || !last_name || !age || !sex	 || !address	 || !city	 || !phone_number	 || !entry_date	 || !doctor_number	 || !diagnosis	 || !department_name ||
                    !treatment_given || !treatment_advice || !payment_made || !mode_of_payment	 || !date_of_discharge){
                ...
                <div className=''>
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div className='shadow-lg'>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor' type="text" id='date_of_discharge' name="date_of_discharge" placeholder='Date Discharge...' value={date_of_discharge || ""} onChange={handleInputChange}/>
                            </div>
